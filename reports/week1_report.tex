...
\begin{itemize}
  \item \texttt{configs/configs\_before\_correction/oxide\_week1\_N50\_seed0.finetune\_last2.json}
  \item \texttt{configs/configs\_before\_correction/nitride\_week1\_N50\_seed0.finetune\_last2.json}
\end{itemize}
...
python scripts/shared/Fine_Tune_Last_Two_ALIGNN_Layers.py \
  --config configs/configs_before_correction/oxide_week1_N50_seed0.finetune_last2.json \
...
python scripts/shared/Fine_Tune_Last_Two_ALIGNN_Layers.py \
  --config configs/configs_before_correction/nitride_week1_N50_seed0.finetune_last2.json \
...
git add configs/configs_before_correction/oxide_week1_N50_seed0.finetune_last2.json
git add configs/configs_before_correction/nitride_week1_N50_seed0.finetune_last2.json
