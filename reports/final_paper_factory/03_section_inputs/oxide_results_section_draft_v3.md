# Oxide Standalone Report — Results (Draft v3)
...
**What the pattern is consistent with.** Oxides serve as the in-distribution control arm by project design. The pretrained model and training data used here derive from the JARVIS materials infrastructure [CITE: Choudhary et al. 2020 — JARVIS; CITE: Choudhary et al. 2024 — JARVIS-Leaderboard]. We do not make separate claims about the exact chemical composition of the pretraining corpus.
