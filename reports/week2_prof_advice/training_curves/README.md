...
Family grid figures:
- oxide: `reports/week2_prof_advice/training_curves/oxide_training_curve_grid.png` and `reports/week2_prof_advice/training_curves/oxide_training_curve_grid.pdf`
- nitride: `reports/week2_prof_advice/training_curves/nitride_training_curve_grid.png` and `reports/week2_prof_advice/training_curves/nitride_training_curve_grid.pdf`
