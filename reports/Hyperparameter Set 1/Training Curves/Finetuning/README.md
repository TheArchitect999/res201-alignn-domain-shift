...
Family grid figures:
- oxide: `reports/Hyperparameter Set 1/Training Curves/Finetuning/oxide_training_curve_grid.png` and `reports/Hyperparameter Set 1/Training Curves/Finetuning/oxide_training_curve_grid.pdf`
- nitride: `reports/Hyperparameter Set 1/Training Curves/Finetuning/nitride_training_curve_grid.png` and `reports/Hyperparameter Set 1/Training Curves/Finetuning/nitride_training_curve_grid.pdf`
