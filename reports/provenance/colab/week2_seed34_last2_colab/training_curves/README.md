...
Family grid figures:
- oxide: `/content/res201-alignn-domain-shift/reports/week2_seed34_last2_colab/training_curves/oxide_training_curve_grid.png` and `/content/res201-alignn-domain-shift/reports/week2_seed34_last2_colab/training_curves/oxide_training_curve_grid.pdf`
- nitride: `/content/res201-alignn-domain-shift/reports/week2_seed34_last2_colab/training_curves/nitride_training_curve_grid.png` and `/content/res201-alignn-domain-shift/reports/week2_seed34_last2_colab/training_curves/nitride_training_curve_grid.pdf`
