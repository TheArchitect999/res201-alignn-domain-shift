...
REPORT_DIR="reports/week2_last2_epochs100_bs32_lr5e5"
...
python scripts/shared/plot_week2_training_curves.py \
  ...
  --Ns 10 50 100 200 500 1000 \
  --seeds 0 1 2 3 4 \
  --out-dir "${REPORT_DIR}/training_curves" \
...
bash scripts/shared/check_week2_finetune_epochs100_bs32_lr5e5_status.sh . "$RUN_SUBDIR" "$REPORT_DIR"
