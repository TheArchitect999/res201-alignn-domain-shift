...
REPORTING_DEPENDENCY_HINT = (
    ...
    "`env/bootstrap_res201_colab_week3_fromscratch_epochs100_bs32_lr5e5.sh`."
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--run-subdir",
        default="train_alignn_fromscratch_epochs100_bs32_lr5e5",
    )
    parser.add_argument("--out-dir", default="reports/week3_fromscratch_epochs100_bs32_lr5e5")
    parser.add_argument(
        "--title-label",
        default="Week 3 From-Scratch Comparison (zero-shot reference only)",
    )
