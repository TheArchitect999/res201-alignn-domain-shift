...
def main() -> int:
    ...
    parser.add_argument("--results-root", default="Results_Hyperparameter_Set_2")
    parser.add_argument("--finetune-results-root", default="Results_Hyperparameter_Set_2")
    ...
    parser.add_argument("--out-dir", default="reports/Hyperparameter Set 2/Summaries/From Scratch")
